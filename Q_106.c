// Q106: Write a program to take an array arr[] of integers as input, the task is to
...
// does not exist next greater of current element, then next greater element for
